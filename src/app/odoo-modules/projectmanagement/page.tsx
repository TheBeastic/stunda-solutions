    ...
    return (
        <main className="min-h-screen pt-32 pb-24 bg-zinc-50 relative overflow-hidden">
            ...
            <div className="container mx-auto px-6 max-w-5xl relative z-10">
                ...
                <div className="rounded-2xl bg-gradient-to-br from-orange-500/10 via-brand-indigo/5 to-transparent border border-orange-200/50 p-12 md:p-16 flex flex-col items-center justify-center text-center mb-16">
                    <Briefcase className="w-16 h-16 text-orange-500/40 mb-4" />
                    <p className="text-brand-indigo/40 font-medium text-sm">Screenshot van het Project Kanban Board</p>
                </div>
                ...
                <div className="rounded-2xl bg-gradient-to-br from-brand-indigo/5 via-orange-500/5 to-transparent border border-brand-indigo/10 p-12 md:p-16 flex flex-col items-center justify-center text-center mb-16">
                    <KanbanSquare className="w-16 h-16 text-brand-indigo/20 mb-4" />
                    <p className="text-brand-indigo/40 font-medium text-sm">Voorbeeld van Gantt-chart voor projectplanning</p>
                </div>
