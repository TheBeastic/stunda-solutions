            ...
            <div className="container mx-auto px-6 max-w-4xl relative z-10">
                ...
                <div className="prose prose-lg prose-indigo max-w-none text-brand-indigo/80">
                    <p className="text-xl mb-8 leading-relaxed font-medium">
                        Een succesvolle ERP-implementatie valt of staat met afstemming. Tijdens de Kick-off zorgen we dat alle <strong className="text-brand-purple">stakeholders op één lijn zitten</strong> en klaar zijn voor het veranderingsproces.
                    </p>
                    <p className="mb-6">
                        Deze fase beslaat de volgende 5% van de doorlooptijd. We introduceren het projectteam, inclusief uw dedicated <strong className="text-brand-indigo underline decoration-brand-purple decoration-2">SPOC (Single Point of Contact)</strong>, die uw interne team door het gehele traject zal leiden. Deze vaste contactpersoon zorgt voor heldere, efficiënte communicatie vanaf dag één.
                    </p>
                    <p className="mb-12">
                        Daarnaast verzorgen we een initiële standaard training in Odoo, zodat het kernteam alvast feeling krijgt met de software-logica voordat het maatwerk begint. Verwachtingsmanagement is hier het sleutelwoord.
                    </p>
                </div>
